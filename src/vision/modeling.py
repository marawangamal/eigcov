...
def apply_lora(
    image_encoder, rank, alpha, dropout, target_modules, target_parameters=None
):
    ...
    config = LoraConfig(
        ...
        target_modules=[],
        target_parameters=["in_proj_weight"],
    )
    image_encoder.model = get_peft_model(image_encoder.model, config)
    return image_encoder


def merge_lora(image_encoder):
    image_encoder.model = image_encoder.model.merge_and_unload()
    return image_encoder
